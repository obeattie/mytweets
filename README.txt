...
(These are found in your application settings, the first two on the Application Details page, and the second two on the "My Access Token" page)

3. Run the command like so:

python fetch.py

4. Your tweets will be saved to my_tweets.json
